 ...
 */
export function note_on(index, velocity) {
    const ret = wasm.note_on(index, velocity);
    if (ret[1]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('kalimba-app_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
